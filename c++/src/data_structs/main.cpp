...
<'I3', <col0,   1   0   0   0><col1,   0   1   0   0><col2,   0   0   1   0>> OR by rows...
  ...
  0   0   1
>
<'a+I3', <col0,   3   0   2   0><col1,   2   0  -2   0><col2,   0   1   1   0>> OR by rows...
  3   2   0
  0   0   1
  2  -2   1
>
...
>
test cofactor
<'a_Cofactor', <col0,   2  -2   2   0><col1,   2   3  -3   0><col2,   0  10   0   0>> OR by rows...
  2   2  -0
 -2   3  10
  2  -3   0
>
<'b_Cofactor', <col0, -24  20  -5   0><col1,  18 -15   4   0><col2,   5  -4   1   0>> OR by rows...
-24  18   5
 20 -15  -4
 -5   4   1
>
test adjoint
<'a_CofactorTranspose', <col0,   2   2   0   0><col1,  -2   3  10   0><col2,   2  -3   0   0>> OR by rows...
  2  -2   2
  2   3  -3
 -0  10   0
>
<'b_CofactorTranspose', <col0, -24  18   5   0><col1,  20 -15  -4   0><col2,  -5   4   1   0>> OR by rows...
-24  20  -5
 18 -15   4
  5  -4   1
>
test inverse
<'0.100000*a_CofactorTranspose', <col0*0.100000, 0.2 0.2   0   0><col1*0.100000, -0.2 0.3   1   0><col2*0.100000, 0.2 -0.3   0   0>> OR by rows...
0.2 -0.2 0.2
0.2 0.3 -0.3
 -0   1   0
>
<'1.000000*b_CofactorTranspose', <col0*1.000000, -24  18   5   0><col1*1.000000,  20 -15  -4   0><col2*1.000000,  -5   4   1   0>> OR by rows...
-24  20  -5
 18 -15   4
  5  -4   1
>
