...
//	// bottom right back
	...
	// the faces
	// bottom face: -ve y	
	Rect* bottom_face	= new Rect(	Point3D(p0.x + rb, p0.y, p0.z + rb),
	...
	// bottom face: +ve y	
	Rect* top_face 	= new Rect(	Point3D(p0.x + rb, p1.y, p0.z + rb), 
												Vector3D(0, 0, (p1.z - rb) - (p0.z + rb)),
												Vector3D((p1.x - rb) - (p0.x + rb), 0, 0),
												Normal(0, 1, 0));
	...
	// back face: -ve z	
	Rect* back_face 	= new Rect(	Point3D(p0.x + rb, p0.y + rb, p0.z), 
												Vector3D((p1.x - rb) - (p0.x + rb), 0, 0),
	...
	// front face: +ve z	
	Rect* front_face 	= new Rect(	Point3D(p0.x + rb, p0.y + rb, p1.z), 
												Vector3D((p1.x - rb) - (p0.x + rb), 0, 0),
												Vector3D(0, (p1.y - rb) - (p0.y + rb), 0),
												Normal(0, 0 , 1));
	...
	// left face: -ve x	
	Rect* left_face 	= new Rect(	Point3D(p0.x, p0.y + rb, p0.z + rb), 
												Vector3D(0, 0, (p1.z - rb) - (p0.z + rb)),
												Vector3D(0, (p1.y - rb) - (p0.y + rb), 0),
												Normal(-1, 0 , 0));
	...
	// right face: +ve x	
	Rect* right_face 	= new Rect(	Point3D(p1.x, p0.y + rb, p0.z + rb), 
												Vector3D(0, 0, (p1.z - rb) - (p0.z + rb)),
												Vector3D(0, (p1.y - rb) - (p0.y + rb), 0),
												Normal(1, 0 , 0));
