...
// ------------------------------------------------------------------- set_num_sets
void
Sampler::set_num_sets(const int np) { num_sets = np; }
// ------------------------------------------------------------------- get_num_samples
int
Sampler::get_num_samples(void) { return (num_samples); }
...
Point2D
Sampler::sample_one_set(void) { return(samples[count++ % num_samples]); }
