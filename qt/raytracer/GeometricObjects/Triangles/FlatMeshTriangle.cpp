...
FlatMeshTriangle::FlatMeshTriangle( const FlatMeshTriangle &fmt ) : MeshTriangle( fmt ) {}
...
//         TODO: check against textbook
// ----------------------------------------------------------------
bool FlatMeshTriangle::shadow_hit( const Ray &ray, double &tmin ) const {
