...
SmoothMeshTriangle::SmoothMeshTriangle( void ) : MeshTriangle() {}
...
SmoothMeshTriangle::SmoothMeshTriangle( const SmoothMeshTriangle &fmt ) : MeshTriangle( fmt ) {}
...
Normal SmoothMeshTriangle::interpolate_normal( const float beta, const float gamma ) const {
  Normal normal( ( 1 - beta - gamma ) * mesh_ptr->normals[index0] + beta * mesh_ptr->normals[index1]
...
// ----------------------------------------------------------------
// TODO: CHECK CODE for shadow_hit
bool SmoothMeshTriangle::shadow_hit( const Ray &ray, double &tmin ) const {
  Point3D v0( mesh_ptr->vertices[index0] );
  Point3D v1( mesh_ptr->vertices[index1] );
  Point3D v2( mesh_ptr->vertices[index2] );
