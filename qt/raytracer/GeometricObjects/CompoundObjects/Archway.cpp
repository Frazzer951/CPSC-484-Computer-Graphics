...
//#include "GeometricObjects/BeveledObjects/BeveledWedge.h"

//// ------------------------------------------------------------------------------ constructor

//Archway::Archway(double _width,
//                double _height,
//                double _depth,
...
//// ------------------------------------------------------------------------------ clone
//Archway* Archway::clone(void) const { return(new Archway(*this)); }

//// ------------------------------------------------------------------------------ assignment operator
//Archway& Archway::operator= (const Archway& rhs) {
...
//// ------------------------------------------------------------------------------ construct_archway
//void Archway::construct_archway(void) {
...
//bool Archway::shadow_hit(const Ray& ray, double& tmin) const {
//  if (!shadows)
//    return false;
