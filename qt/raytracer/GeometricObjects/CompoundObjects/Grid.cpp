...
//Grid*
//Grid::clone(void) const { return (new Grid (*this)); }
//// ---------------------------------------------------------------- copy constructor
//// not implemented
...
//Grid&
//Grid::operator= (const Grid& rhs)	{ return *this; }
//// ---------------------------------------------------------------- destructor
//// not implemented
...
//BBox
//Grid::get_bounding_box(void) { return (bbox); }
////------------------------------------------------------------------ setup_cells
...
//void
//Grid::read_flat_triangles(char* file_name) { read_ply_file(file_name, flat); }
...
//        std::cout << "element name  " << elem_name << "  num elements = " << num_elems << "  num properties =  "
//                  << nprops << std::endl;
...
//// ----------------------------------------------------------------
//bool Grid::shadow_hit(const Ray&, double&) const {
