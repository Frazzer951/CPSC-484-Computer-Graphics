...
FlatRimmedBowl::FlatRimmedBowl( double i_r, double o_r, const Point3D &c ) : Compound() {
...
FlatRimmedBowl::FlatRimmedBowl( const FlatRimmedBowl &b ) : Compound( b ) {}

FlatRimmedBowl *FlatRimmedBowl::clone( void ) const { return new FlatRimmedBowl( *this ); }
...
bool FlatRimmedBowl::hit( const Ray &ray, double &tmin, ShadeRec &sr ) const { return Compound::hit( ray, tmin, sr ); }

bool FlatRimmedBowl::shadow_hit( const Ray &ray, double &tmin ) const {
