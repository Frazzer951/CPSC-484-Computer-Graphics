...
Instance* 
Instance::clone(void) const { return (new Instance(*this)); }
// ---------------------------------------------------------------- destructor
...
void 												
Instance::set_object(GeometricObject* obj_ptr) { object_ptr = obj_ptr; }
//---------------------------------------------------------------- set_bounding_box
...
BBox 
Instance::get_bounding_box(void) { return (bbox); }
//---------------------------------------------------------------- get_material
																
Material* 
Instance::get_material(void) const { return (material_ptr); }
//---------------------------------------------------------------- set_material
// Here, material_ptr is GeometricObject::material_ptr

void 
Instance::set_material(Material* m_ptr) { material_ptr = m_ptr; }
//----------------------------------------------------------------------------------------- hit 
