...
// ---------------------------------------------------------------- default constructor
Torus::Torus( void ) : GeometricObject(), a( 2.0 ), b( 0.5 ), bbox( -a - b, a + b, -b, b, -a - b, a + b ) {}
// ---------------------------------------------------------------- constructor

Torus::Torus( const double _a, const double _b ) :
    GeometricObject(), a( _a ), b( _b ), bbox( -a - b, a + b, -b, b, -a - b, a + b ) {}

// ---------------------------------------------------------------- clone

Torus *Torus::clone( void ) const { return ( new Torus( *this ) ); }

// ---------------------------------------------------------------- copy constructor

Torus::Torus( const Torus &torus ) : GeometricObject( torus ), a( torus.a ), b( torus.b ), bbox( torus.bbox ) {}
