...
GenericSphere::GenericSphere( void ) : GeometricObject() {}

GenericSphere *GenericSphere::clone( void ) const { return new GenericSphere( *this ); }

GenericSphere::GenericSphere( const GenericSphere &GenericSphere ) : GeometricObject( GenericSphere ) {}
...
BBox GenericSphere::get_bounding_box( void ) const { return BBox( -1, 1, -1, 1, -1, 1 ); }
