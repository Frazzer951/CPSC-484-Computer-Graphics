...
ConvexCylinder::ConvexCylinder( void ) : GeometricObject(), y0( -1.0 ), y1( 1.0 ), radius( 1.0 ), inv_radius( 1.0 ) {}
...
ConvexCylinder *ConvexCylinder::clone( void ) const { return new ConvexCylinder( *this ); }
...
bool ConvexCylinder::shadow_hit( const Ray &ray, double &tmin ) const {
