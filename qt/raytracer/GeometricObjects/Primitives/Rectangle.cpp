...
Rectangle::Rectangle( void ) :
    GeometricObject(), p0( -1, 0, -1 ), a( 0, 0, 2 ), b( 2, 0, 0 ), a_len_squared( 4.0 ), b_len_squared( 4.0 ),
...
void Rectangle::set_sampler( Sampler *sampler ) { sampler_ptr = sampler; }
...
Normal Rectangle::get_normal( const Point3D & ) { return ( normal ); }
// ---------------------------------------------------------------- pdf

float Rectangle::pdf( ShadeRec & ) { return ( inv_area ); }
