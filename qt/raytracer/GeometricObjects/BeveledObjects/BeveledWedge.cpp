...
#include "GeometricObjects/PartObjects/ConcavePartCylinder.h"
...
BeveledWedge::BeveledWedge( const double _y0,         // minimum y value
    ...
    y0( _y0 ),
    y1( _y1 ), r0( _r0 ), r1( _r1 ), rb( _rb ), phi0( _phi0 ), phi1( _phi1 ) {
...
BeveledWedge::BeveledWedge( const BeveledWedge &bw ) :
    Compound( bw ), y0( bw.y0 ), y1( bw.y1 ), r0( bw.r0 ), r1( bw.r1 ), rb( bw.rb ), phi0( bw.phi0 ), phi1( bw.phi1 ),
    bbox( bw.bbox ) {}
...
// ------------------------------------------------------------------------------ get_bounding_box
BBox BeveledWedge::get_bounding_box( void ) const { return bbox; }
...
bool BeveledWedge::shadow_hit( const Ray &ray, double &tmin ) const {
