...
//BeveledWedge::BeveledWedge(double _y0,		// minimum y value
//                           double _y1,		// minimum y value
//                           double _r0,		// inner radius
//                           double _r1,		// outer radius
//                           double _rb,		// bevel radius
//                           double _phi0,		// minimum azimuth angle in degrees
//                           double _phi1)		// maximum azimuth angle in degrees
...
//	Rect* phi0_rect_ptr = new Rect(p1, a, b);
//	objects.push_back(phi0_rect_ptr);
...
//	Rect* phi1_rect_ptr = new Rect(p4, a, b);
//	objects.push_back(phi1_rect_ptr);
...
// ----------------------------------------------------------------
//bool BeveledWedge::shadow_hit(const Ray&, double&) const {
