...
// ---------------------------------------------------------------- clone
ConcavePartCylinder *ConcavePartCylinder::clone( void ) const { return new ConcavePartCylinder( *this ); }
...
bool ConcavePartCylinder::shadow_hit( const Ray &ray, double &tmin ) const {
