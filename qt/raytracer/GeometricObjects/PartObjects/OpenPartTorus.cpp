...
OpenPartTorus::OpenPartTorus( const double i_r, const double o_r,
...
OpenPartTorus *OpenPartTorus::clone( void ) const { return new OpenPartTorus( *this ); }

// ---------------------------------------------------------------- copy constructor

OpenPartTorus::OpenPartTorus( const OpenPartTorus &ps ) :
...
OpenPartTorus &OpenPartTorus::operator=( const OpenPartTorus &rhs ) {
...
Normal OpenPartTorus::compute_normal( const Point3D &p ) const {
  Normal normal;
...
bool OpenPartTorus::hit( const Ray &ray, double &tmin, ShadeRec &sr ) const {
  ...
  if ( -ray.d.dot( sr.normal ) < 0.0 ) sr.normal = -sr.normal;    // points towards camera

  return true;
}

bool OpenPartTorus::shadow_hit( const Ray &ray, double &tmin ) const {
