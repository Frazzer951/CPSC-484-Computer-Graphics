#include "GeometricObjects/PartObjects/ConvexPartTorus.h"
...
ConvexPartTorus::ConvexPartTorus( const double i_r, const double o_r,
...
ConvexPartTorus *ConvexPartTorus::clone( void ) const { return new ConvexPartTorus( *this ); }
...
bool ConvexPartTorus::shadow_hit( const Ray &ray, double &tmin ) const {
