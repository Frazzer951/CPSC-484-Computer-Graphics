#include "GeometricObjects/PartObjects/ConvexPartCylinder.h"
...
ConvexPartCylinder *ConvexPartCylinder::clone( void ) const { return new ConvexPartCylinder( *this ); }
...
bool ConvexPartCylinder::shadow_hit( const Ray &ray, double &tmin ) const {
