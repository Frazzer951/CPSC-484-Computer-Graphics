...
////#define SCALE_RADIANCE 4.5
//#define SCALE_RADIANCE 38.5

//void
//World::build(void){         // this is 27.14
//    int num_samples = 16;
...
//    light_ptr1->scale_radiance(SCALE_RADIANCE);
...
//    light_ptr2->scale_radiance(SCALE_RADIANCE);
...
//    light_ptr3->scale_radiance(SCALE_RADIANCE);
