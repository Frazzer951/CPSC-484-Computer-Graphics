...
private:
  void copy( const GlossyReflector &other );
...
inline void GlossyReflector::set_cr( const RGBColor c ) { glossy_specular_brdf->set_cs( c ); }

inline void GlossyReflector::set_cr( const float r, const float g, const float b ) { glossy_specular_brdf->set_cs( r, g, b ); }

inline void GlossyReflector::set_cr( const float c ) { glossy_specular_brdf->set_cs( c ); }
