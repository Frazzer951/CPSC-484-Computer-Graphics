...
//inline int
//rand_int(void) {  return(rand()); }
//// ---------------------------------------------------- rand_float

//inline float
//rand_float(void) { return((float)rand_int() * invRAND_MAX); }
//// ---------------------------------------------------- set_rand_seed
...
//inline float
//rand_float(int l, float h) { return (rand_float() * (h - l) + l); }
//// ---------------------------------------------------- rand_int with arguments

//inline int
//rand_int(int l, int h) { return ((int) (rand_float(0, h - l + 1) + l)); }
//// ---------------------------------------------------- clamp
