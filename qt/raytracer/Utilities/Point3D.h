...
inline Point3D Point3D::operator*( const double a ) const { return ( Point3D( x * a, y * a, z * a ) ); }
// -------------------------------------------------------------- d_squared
...
inline Point3D operator*( double a, const Point3D &p ) { return ( Point3D( a * p.x, a * p.y, a * p.z ) ); }
