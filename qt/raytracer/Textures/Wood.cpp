...
//{
//    if (wood.noise_ptr) {
//        noise_ptr->reset(wood.noise_ptr->clone());
//    } else  { noise_ptr->reset(NULL); }
//}

//// ------------------------------------------------------------------------------------------ assignment operator
//Wood& Wood::operator= (const Wood& rhs) {
...
//    if (rhs.noise_ptr) {
//        noise_ptr->reset(rhs.noise_ptr->clone());
//    }
...
//// ------------------------------------------------------------------------------------------ clone
//Wood*	Wood::clone(void) const { return (new Wood(*this)); }
...
//// -------------------------------------------------------------------- set_noisevoid
//void Wood::set_noise(LatticeNoise* _noise_ptr) { noise_ptr = _noise_ptr; }
//// -------------------------------------------------------------------- set_num_octaves
//void Wood::set_num_octaves(const int _num_octaves) {
//    noise_ptr->set_num_octaves(_num_octaves);
//}
//// -------------------------------------------------------------------- set_lacunarity
//void Wood::set_lacunarity(const float _lacunarity) {
//    noise_ptr->set_lacunarity(_lacunarity);
//}
//// -------------------------------------------------------------------- set_gain
//void Wood::set_gain(const float _gain)  { noise_ptr->set_gain(_gain); }
//// -------------------------------------------------------------------- set_light_color
//void Wood::set_light_color(const RGBColor& c) { light_color = c; }
//// -------------------------------------------------------------------- set_light_color
//void Wood::set_light_color(const float r,  const float g, const float b) {
//    light_color.r = r;
//    light_color.b = b;
//    light_color.g = g;
//}
//// -------------------------------------------------------------------- set_light_color
//void Wood::set_light_color(const float c) {
//  	light_color.r = light_color.b = light_color.g = c;
//}
//// -------------------------------------------------------------------- set_dark_color
//void Wood::set_dark_color(const RGBColor& c) { dark_color = c; }
//// -------------------------------------------------------------------- set_dark_color
//void Wood::set_dark_color(const float r,  const float g, const float b) {
//    dark_color.r = r;
//    dark_color.b = b;
//    dark_color.g = g;
//}
//// -------------------------------------------------------------------- set_dark_color
//void Wood::set_dark_color(const float c) {
//  	dark_color.r = dark_color.b = dark_color.g = c;
//}
//// -------------------------------------------------------------------- set_ring_frequency
//void Wood::set_ring_frequency(const double _ring_frequency) {
//    ring_frequency = _ring_frequency;
//}
//// -------------------------------------------------------------------- set_ring_uneveness
//void Wood::set_ring_uneveness(const double _ring_uneveness) {
//  	ring_uneveness = _ring_uneveness;
//}
//// -------------------------------------------------------------------- set_ring_noise
//void Wood::set_ring_noise(const double _ring_noise) { ring_noise = _ring_noise; }
//// -------------------------------------------------------------------- set_ring_noise_frequency
//void Wood::set_ring_noise_frequency(const double _ring_noise_frequency) {
//  	ring_noise_frequency = _ring_noise_frequency;
//}
//// -------------------------------------------------------------------- set_trunk_wobble
//void Wood::set_trunk_wobble(const double _trunk_wobble) { trunk_wobble = _trunk_wobble; }
//// -------------------------------------------------------------------- set_trunk_wobble_frequency
//void Wood::set_trunk_wobble_frequency(const double _trunk_wobble_frequency) {
//  	trunk_wobble_frequency = _trunk_wobble_frequency;
//}
//// -------------------------------------------------------------------- set_angular_wobble
//void Wood::set_angular_wobble(const double _angular_wobble) {
//  	angular_wobble = _angular_wobble;
//}
//// -------------------------------------------------------------------- set_angular_wobble_frequency
//void Wood::set_angular_wobble_frequency(const double _angular_wobble_frequency) {
//  	angular_wobble_frequency = _angular_wobble_frequency;
//}
//// -------------------------------------------------------------------- set_grain_frequency
//void Wood::set_grain_frequency(const double _grain_frequency) {
//  	grain_frequency = _grain_frequency;
//}
//// -------------------------------------------------------------------- set_grainy
//void Wood::set_grainy(const double _grainy) { grainy = _grainy; }
//// -------------------------------------------------------------------- set_ringy
//void Wood::set_ringy(const double _ringy) { ringy = _ringy; }
