...
SphericalMap::SphericalMap( void ) : Mapping() {}

// ---------------------------------------------------------------- copy constructor

SphericalMap::SphericalMap( const SphericalMap &sm ) : Mapping( sm ) {}
...
SphericalMap *SphericalMap::clone( void ) const { return ( new SphericalMap( *this ) ); }
...
void SphericalMap::get_texel_coordinates( const Point3D &local_hit_point, const int xres, const int yres, int &row,
                                          int &column ) const {
