...
HemisphericalMap::HemisphericalMap( void ) : Mapping() {}

// ---------------------------------------------------------------- copy constructor

HemisphericalMap::HemisphericalMap( const HemisphericalMap &sm ) : Mapping( sm ) {}
...
HemisphericalMap *HemisphericalMap::clone( void ) const { return ( new HemisphericalMap( *this ) ); }
...
void HemisphericalMap::get_texel_coordinates( const Point3D &local_hit_point, const int xres, const int yres, int &row,
                                              int &column ) const {
